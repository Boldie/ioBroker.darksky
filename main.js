...
function main() {
	...
	request(apiurl + secretKey + '/' + adapter.config.iob_lat + ',' + adapter.config.iob_lon + '?units=si&lang=de', {
		...
		setOrUpdateState('current.precipProbability', 'Precipitation probability', body.currently.precipProbability, '%', 'number', 'value.probability');
		...
		setOrUpdateState('current.humidity', 'Hunidity', body.currently.humidity, '%', 'number', 'value.humidity');
		...
		setOrUpdateState('current.cloudCover', 'Cloud coverage', body.currently.cloudCover, '%', 'number', 'value');
		...
		body.hourly.data.forEach(function(value) {
			...
			setOrUpdateState('hourly.' + i + '.precipProbability', 'Precipitation probability', value.precipProbability, '%', 'number', 'value.probability');
			...
			setOrUpdateState('hourly.' + i + '.humidity', 'Hunidity', value.humidity, '%', 'number', 'value.humidity');
			...
			setOrUpdateState('hourly.' + i + '.cloudCover', 'Cloud coverage', value.cloudCover, '%', 'number', 'value');
		...
		body.daily.data.forEach(function(value) {
			...
			setOrUpdateState('daily.' + i + '.precipProbability', 'Precipitation probability', value.precipProbability, '%', 'number', 'value.probability');
			...
			setOrUpdateState('daily.' + i + '.humidity', 'Hunidity', value.humidity, '%', 'number', 'value.humidity');
			...
			setOrUpdateState('daily.' + i + '.cloudCover', 'Cloud coverage', value.cloudCover, '%', 'number', 'value');
